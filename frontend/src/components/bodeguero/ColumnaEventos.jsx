// Archivo: ColumnaEventos.jsx
// Ruta: frontend/src/components/bodeguero/ColumnaEventos.jsx
// Función: columna central del Dashboard — carga y filtra eventos del deporte
//          activo, renderiza la lista de TarjetaEvento. Extraído de
//          DashboardPage.jsx (Paso 2 de reorganización components/).
...
export default function ColumnaEventos({ deporte, seleccionesActivas, limiteAlcanzado, onSeleccionar }) {
      ...
      <div className="flex items-center gap-2 px-4 py-2.5 border-b border-white/5 shrink-0">
        <div className="relative flex-1 max-w-xs">
          ...
          <input
            ...
            placeholder="Filtrar por equipo o liga…"
        ...
        <button
          onClick={cargar}
          disabled={cargando}
          className="flex items-center gap-1.5 text-[#94a3b8] hover:text-white text-xs border border-white/10 hover:border-white/20 rounded-lg px-3 py-2 transition disabled:opacity-40"
        >
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3">
        {cargando && (
          <div className="flex flex-col items-center justify-center py-16 gap-3">
            ...
            <span className="text-[#94a3b8] text-sm">Cargando eventos…</span>
          </div>
        )}
        ...
        {!cargando && !error && eventosFiltrados.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 gap-2">
            ...
            <span className="text-[#475569] text-sm">Sin eventos disponibles</span>
          </div>
        )}
